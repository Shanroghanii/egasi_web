    ...
    <>
      ...
      <div class="container mx-auto px-4 mt-5">
        <div className="flex justify-center ">
          <div className="bg-white shadow-md items-center p-2 rounded-lg max-w-[1100px]">
            <div className="grid grid-cols-1 gap-2 px-3 md:grid-cols-3 lg:grid-cols-5 mt-1">
              <div>
              ...
              <div>
                <div className="flex px-2 ">
                  <img src={Homme} alt="" />
                  <p className="mt-2 px-2">Purpose</p>
                </div>
                <div>
                  <Form.Select
                    style={{
      ...
      <div className="container mt-5">
        <div className="flex justify-between flex-col md:flex-row">
          <div className="bg-white shadow-md p-4"  style={{ width: "19rem", }}>
